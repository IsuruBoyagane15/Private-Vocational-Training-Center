...
<body>
    ...
    <div id="abtus">
      ...
      <ul>
        ...
        <li>Conduct training trainers programs in order to deliver the training effectively and efficiently.</li>
        <li>Conduct competency and based assessments / final assessments and issue National Vocational Qualification (NVQ) and other skills certificate respectively.</li>
        <li>Provide career guidance and counselling to school leavers and other youth.</li>
      </ul>
    ...
    <li>Align to skill needs</li>
    <li>Striving to achieve excellence</li>
    <li>Being responsible and accountable at all levels</li>
    <li>Commitment to highest Quality and Integrity</li>
    <li>Team Sprit</li>
    ...
    <li>Conduct trade tests, final assessments and issuing National Vocational Qualification certificates through TVEC.</li>
    <li>Conduct career guidance and counseling programs.</li>
    <li>Conduct trainer training programs in order to operate the vocational training program efficiently and effectively.</li>
